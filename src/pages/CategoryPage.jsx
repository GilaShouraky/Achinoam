...
const subCatVisuals = {
  ...
  invitations:   { emoji: '✉️', bg: 'linear-gradient(145deg, #E8EEF8, #C0CCE8)' },
  flyers:        { emoji: '📄', bg: 'linear-gradient(145deg, #EAF0F8, #C8D4EC)' },
  branding:      { emoji: '🏷️', bg: 'linear-gradient(145deg, #E8EDF5, #C0C8D8)' },
...
const catMeta = {
  products:  { title: 'המוצרים שלי',   color: 'var(--rose)',  grad: 'var(--grad-rose)',  headerBg: 'linear-gradient(135deg, #C4A0AC, #A8788A)', targetPage: 'products' },
  graphics:  { title: 'עבודות גרפיקה', color: 'var(--slate)', grad: 'var(--grad-slate)', headerBg: 'linear-gradient(135deg, #8AAEC4, #6A94B0)', targetPage: 'graphics' },
  workshops: { title: 'סדנאות אומנות', color: 'var(--amber)', grad: 'var(--grad-amber)', headerBg: 'linear-gradient(135deg, #D4A840, #BF922A)', targetPage: 'workshops' },
};
